 ...
 <div class="container"><br>
  <div class="row">
    <div class="col-sm-12 text-center">
      ...
      <div class="copyright">
        <p class="white"> copyright &copy; <b>sandeep's restaurant</b></p>
        <p><i class="fa fa-phone"></i> +91 1234567890 &nbsp;<i class="fa fa-envelope-o"></i> sandeeprestaurants@gmail.com</p>
      </div>
    </div>
  </div>
 </div>
